...
import com.jane.buyherebackend.helper.ProductSaveHelper;
import com.jane.buyherebackend.paging.PagingAndSortingHelper;
import com.jane.buyherebackend.paging.PagingAndSortingParam;
import com.jane.buyherebackend.security.BuyhereUserDetails;
...
public class ProductController {
	...
	public String listByPage(
		...
		LOGGER.info("ProductController | listByPage | listCategories : " + listCategories.toString());
	...
	public String saveProduct(Product product, RedirectAttributes ra,
			...
			@AuthenticationPrincipal BuyhereUserDetails loggedUser
			) throws IOException {
	...
	public String deleteProduct(@PathVariable(name = "id") Integer id, 
		...
		try {
			...
			String productExtraImagesDir = "buyhereWebparent/product-images/" + id + "/extras";
			String productImagesDir = "buyhereWebparent/product-images/" + id;
