...
$(document).ready(function() {
	...
	buttonAddCountry.click(function() {
		if (buttonAddCountry.val() == "Add") {
			console.log("will start check unique country");
			if(checkUniqueCountry()){
				console.log("will start adding country");
				addCountry();
			}	
		} else {
...
function checkUniqueCountry() {
	...
	console.log("country checkUnique is working");
