...
$(document).ready(function() {
	...
	buttonAddState.click(function() {
		if (buttonAddState.val() == "Add") {
			console.log("will start check unique state");
			if(checkUniqueState()){
				console.log("will start adding state");
				addState();
			}
		} else {
...
function addState() {
	...
	console.log("start adding state");
...
function checkUniqueState() {
	...
	console.log("state checkUnique is working");
